...
# Load the Nepali font (make sure you have a Nepali font installed, such as "NotoSansDevanagari-Regular.ttf")
# You can download a font like "NotoSansDevanagari" or use any other Nepali font you have.
font_path = './NotoSansDevanagari-Regular.ttf'  # Provide the correct path to your Nepali font
